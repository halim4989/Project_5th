...
<body>
    ...
    <div class="container-fluid" style="margin-top: 6em;">
        ...
        <a class="btn btn-warning disabled">Check Out Logs</a>
        <br />
        <br />
        <table id="table" class="table table-bordered">
            ...
            <tbody>
                <?php
                $query = $conn->query("SELECT * FROM `transaction` NATURAL JOIN `guest` NATURAL JOIN `room` WHERE `status` = 'Check Out'") or die("Connection failed: " . $conn->connect_error);
